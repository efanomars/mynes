...
# File:   uninstall_mynes-all.py

# Removes all files installed by the install_mynes-all.sh script.
...
def main():
	import argparse
	oParser = argparse.ArgumentParser("Removes all files created by install_mynes-all.py")
	...
	subprocess.check_call("./libstmm-mynes/scripts/uninstall_libstmm-mynes.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./libstmm-mynes-xml/scripts/uninstall_libstmm-mynes-xml.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())

	subprocess.check_call("./mynes/scripts/uninstall_mynes.py -y {} {} {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())
