...
g_sSourceProjectName = "mynes"

# The subprojects
g_oSubPrjs = ["libstmm-mynes", "libstmm-mynes-xml", "mynes"]
# The binaries containing shared object libraries for runtime
g_oBinLibs = ["libstmm-mynes", "libstmm-mynes-xml"]
# The binaries containing headers, documents and shared object libraries for building
g_oDevLibs = ["libstmm-mynes-dev", "libstmm-mynes-xml-dev"]
