...
# In addition to the pk_install_mynes-all.py parameters it sets the DESTDIR 
...
def main():
	...
	oParser = argparse.ArgumentParser(description="Install all mynes projects.\n"
						"  Same as pk_install_mynes-all.py but sets DESTDIR environment variable.\n"
	...
	subprocess.check_call("./pk_install_mynes-all.py {} {} {} {} {} {} {} {} {} {} {} {}".format(\
