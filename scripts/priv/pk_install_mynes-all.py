...
# In addition to the install_mynes-all.py parameters it sets the STMM_DEBIAN_PACKAGING
...
def main():
	...
	oParser = argparse.ArgumentParser(description="Install all mynes projects.\n"
						"  Same as install_mynes-all.py but sets STMM_DEBIAN_PACKAGING environment variable\n"
						"  to ON."
	...
	subprocess.check_call("./install_mynes-all.py {} {} {} {} {} {} {} {} {} {} {} {}".format(\
