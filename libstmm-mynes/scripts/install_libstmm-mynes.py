...
# File:   install_libstmm-mynes.py

# Compiles and installs the libstmm-mynes library.
...
def main():
	...
	if not oArgs.bDontConfigure:
		subprocess.check_call("cmake {} {} {} {} {} {} {} ..".format(\
				sBuildStaticLib, sBuildTests, sBuildDocs, sDocsWarningsToLog, sBuildType, sInstallDir, sSanitize).split())
