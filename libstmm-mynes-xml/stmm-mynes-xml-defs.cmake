# File: libstmm-mynes-xml/stmm-mynes-xml-defs.cmake
...
set(STMM_MYNES_XML_MINOR_VERSION 13) # !-U-!
...
set(STMM_MYNES_XML_REQ_STMM_MYNES_MINOR_VERSION 13) # !-U-!
...
set(STMM_MYNES_XML_REQ_STMM_GAMES_XML_GAME_MINOR_VERSION 24) # !-U-!
...
# if (("${CMAKE_SCRIPT_MODE_FILE}" STREQUAL "") AND NOT TARGET stmm-mynes-xml)
#     if (BUILD_SHARED_LIBS)
#         add_library(stmm-mynes-xml SHARED IMPORTED)
#     else()
#         add_library(stmm-mynes-xml STATIC IMPORTED)
#     endif()
#     set_target_properties(stmm-mynes-xml PROPERTIES IMPORTED_LOCATION             "${STMMI_LIB_FILE}")
#     set_target_properties(stmm-mynes-xml PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${STMMMYNESXML_INCLUDE_DIRS}")
#     set(STMMI_TEMP_PROPS "")
#     get_target_property(STMMI_TEMP_STMMMYNES_PROP stmm-mynes INTERFACE_LINK_LIBRARIES)
#     list(APPEND STMMI_TEMP_PROPS "${STMMI_TEMP_STMMMYNES_PROP}")
#     list(APPEND STMMI_TEMP_PROPS "stmm-mynes")
#     list(APPEND STMMI_TEMP_PROPS "${STMMGAMESXMLGAME_LIBRARIES}")
#     set_target_properties(stmm-mynes-xml PROPERTIES INTERFACE_LINK_LIBRARIES      "${STMMI_TEMP_PROPS}")
# endif()
